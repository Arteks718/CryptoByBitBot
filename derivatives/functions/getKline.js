            ...
            clientByBit.getKline({category: "linear", symbol: arrayOfStrings[0].toUpperCase(), interval: String(interval.toUpperCase()), limit: limit})
              .then(async (result) => {
                if(result.retCode == 0) {
                  ...
                  (user.chooseButtonAPI == true) ? ctx.reply("✅Операція виведення списку клинів успішна✅", direvativesAPI) : ctx.reply("✅Операція виведення списку клинів успішна✅", direvativesWithoutAPI)
